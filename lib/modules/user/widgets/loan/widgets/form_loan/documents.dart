...
import '/services/serviceType/loanServices/updateLoan.dart';
...
class _DocumentSectionState extends State<DocumentSection> {
  ...
  String? aadharFile, panFile, bankProofFile, salarySlipFile, photoFile;
  ...
  void initState() {
    ...
    if (widget.existingFiles != null) {
      ...
      photoFile = widget.existingFiles!["photo"];
  ...
  Future<String?> submitDetails() async {
    ...
    try {
      final res = await updateLoanService.updateLoanServiceTypeById(
        id: widget.DBId!,
        token: widget.token,
        ...
        bankStatementFileKey: bankProofFile,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        _documentCard(title: "Bank Proof", type: "bank", fileUrl: bankProofFile),
        _documentCard(title: "Salary Slip", type: "salary", fileUrl: salarySlipFile),
        _documentCard(title: "Photo", type: "photo", fileUrl: photoFile),
      ],
    );
  }
}
