...
import '/controllers/usercontroller/insuranceController/InsuranceformController.dart';
...
class _BasicDetailsSectionState extends State<BasicDetailsSection> {
  ...
  Map<String, dynamic> serviceType() {
    return {
      ...
      "serviceId": "3", 
      "serviceSubType": widget.insuranceType, 
      "status": "Pending", 
    };
  }
  ...
  Future<void> saveDetails({bool validate = true}) async {
    ...
    try {
      ...
      if (dbId != null) {
        await updateApi.updateInsuranceService.updateInsuranceServiceTypeById(
          id: dbId,
          token: widget.token,
          activeSteps: "basicDetails",
          panNumber: widget.panController.text.trim(),
      ...
      child: Column(
        children: [
          TextFormField(
            ...
            validator: InsuranceFormController.validateAadhar,
          ),
          ...
          TextFormField(
            ...
            validator: InsuranceFormController.validatePAN,
          ),
          const SizedBox(height: 12),
        ],
      ),
